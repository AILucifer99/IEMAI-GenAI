...
st.title("Automatic *Textual Sentiment Analysis* Engine ✨")
st.subheader(
    "Just provide the engine with a large chunk of text and our AI model will perform a sentiment analysis for you.", 
    divider="rainbow"
)
