...
def WebsiteSummarizer(**kwargs) :
    if kwargs["parse_function"] :
        ...
        st.title("RAG System - Automatic *Website Scraping and Summary Generation* Engine ✨")
        st.subheader("Just provide a website url and our AI models will scrape and summarize it for you.", divider="rainbow")
