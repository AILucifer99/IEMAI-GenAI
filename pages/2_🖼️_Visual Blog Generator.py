...
st.title("Visual *Image to Blog Generation* Engine ✨")
st.subheader("Just upload an image and watch our AI create an entire description of the same or you can also generate an entire blog for articles.", divider="rainbow")
    ...
    try :
        ...
        with st_lottie_spinner(lottie_loading, height=175, width=175, speed=0.75, quality="high") :
            ...
            if len(response) > 2 :
                ...
                st.warning("Try again, please....")
    except Exception as exp :
        st.warning("Harmful Content Generation Detected, try again....")
