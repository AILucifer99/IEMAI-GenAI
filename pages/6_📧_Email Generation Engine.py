...
st.title("Generate outstanding emails with Automatic *Email Generation* Engine ✨")

st.subheader(
    "Just provide the engine with an *email subject text* and our AI model will write the entire mail for you.", 
    divider="rainbow"
)
